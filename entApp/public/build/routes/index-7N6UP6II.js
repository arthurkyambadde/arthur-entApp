...
var styles_default2 = "/build/_assets/styles-LI6P4SN4.css";
...
var EmailInput = import_react4.default.forwardRef(
  ({ children, ...props }, ref) => {
    ...
    const doValidation = () => {
      ...
      const errorElement = document.querySelector(".text-message");
      const inputElement = document.querySelector(".email_input");
      if ((errorElement == null ? void 0 : errorElement.innerHTML) === errors_default.INVALID_EMAIL) {
        inputElement == null ? void 0 : inputElement.classList.add("redBoarder");
      }
    };
    const changeBorader = (e) => {
      const key = console.log(key);
    };
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", {
...
//# sourceMappingURL=/build/routes/index-7N6UP6II.js.map
