...
var styles_default6 = "/build/_assets/styles-S6EYAF6I.css";
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var icons = [
  { icon: icon_nav_home_default, name: "trending" },
  { icon: icon_nav_movies_default, name: "movies" },
  { icon: icon_nav_tv_series_default, name: "series" },
  { icon: icon_nav_bookmark_default, name: "bookmark" }
];
var trendingMovies = [
  {
    src: small_default,
...
var AuthenticatedApplication = () => {
  const listItems = icons.map((icon) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
...
//# sourceMappingURL=/build/routes/index-ICIHAEHP.js.map
