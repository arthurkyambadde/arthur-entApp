...
var styles_default3 = "/build/_assets/styles-6E5JNIMM.css";
...
var styles_default4 = "/build/_assets/styles-EGRHTMEF.css";
...
// public/assets/thumbnails/community-of-ours/regular/medium.jpg
var medium_default2 = "/build/_assets/medium-AQ3MKNVD.jpg";

// app/components/bookmark/bookmark.tsx
var import_react6 = __toESM(require_react());

// app/components/bookmark/styles.css
var styles_default5 = "/build/_assets/styles-P347O5KF.css";

// public/assets/idle-bookmark--icon.svg
var idle_bookmark_icon_default = "/build/_assets/idle-bookmark--icon-RZYWRGN7.svg";
...
var Bookmark = (props) => {
  const { image } = props;
  const [bookmarkState, setBookmarkState] = (0, import_react6.useState)("idle");
  const handleBookmarkMouseEnter = () => {
    console.log(bookmarkState);
    if (bookmarkState === "idle") {
      return setBookmarkState("hover");
    } else if (bookmarkState === "hovered") {
      return setBookmarkState("idle");
    }
  };
  const handleBookmarkClick = () => {
    console.log("clicked");
    if (bookmarkState === "hover") {
      return setBookmarkState("active");
    } else if (bookmarkState === "active") {
      return setBookmarkState("hover");
    }
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", {
        ...
        fileName: "app/components/bookmark/bookmark.tsx",
        lineNumber: 65,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", {
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var links6 = () => [...links(), ...links5(), ...links2(), ...links3(), ...links4()];
function Index() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Bookmark, {
        image: medium_default2
      }, void 0, false, {
        fileName: "app/routes/index.tsx",
        lineNumber: 27,
        columnNumber: 7
...
//# sourceMappingURL=/build/routes/index-MRGH534B.js.map
