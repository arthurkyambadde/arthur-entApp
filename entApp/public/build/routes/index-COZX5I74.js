...
var EmailInput = import_react5.default.forwardRef(
  ({ children, ...props }, ref) => {
    ...
    (0, import_react2.useEffect)(() => {
      const errorElement2 = document.querySelector(".text-message");
      const inputElement = document.querySelector(".email_input");
      if ((errorElement2 == null ? void 0 : errorElement2.innerHTML) === errors_default.INVALID_EMAIL) {
...
//# sourceMappingURL=/build/routes/index-COZX5I74.js.map
