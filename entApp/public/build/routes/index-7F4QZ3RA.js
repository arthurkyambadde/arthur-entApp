  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState5 = React6.useState, useEffect2 = React6.useEffect, useLayoutEffect = React6.useLayoutEffect, useDebugValue2 = React6.useDebugValue;
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const changeSlide = function(slides) {
      carouselSlides.forEach(
        (slide, index) => slide.style.transform = `translateX(${100 * (index - slides)}%)`
      );
    };
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-7F4QZ3RA.js.map
