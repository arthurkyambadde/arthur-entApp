...
var trendingMoviesList = trendingMovies.map((item2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
...
var recommendedList = recommendedForYour.map((item2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
...
var moviesList = selectedMovies.map((item2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
  className: "recommended_thumbnail--wrapper",
  children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      className: "recommened_thumbnail--ImageContainer",
...
var series = selectedTvSeries.map((item2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
  className: "recommended_thumbnail--wrapper",
  children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      className: "recommened_thumbnail--ImageContainer",
...
var AuthenticatedApplication = () => {
  const listItems = icons.map((item2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
    className: "icon_button",
    onClick: () => {
      showActiveIcon;
    },
    id: item2.id,
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(item2.icon, {
      className: "icon"
    }, void 0, false, {
      fileName: "app/components/authenticatedApplication/authenticatedApplication.tsx",
      lineNumber: 651,
  ...
  const showActiveIcon = (e) => {
    setCategory(item.name);
    console.log("clicked");
    console.log(void 0);
  };
  const [category, setCategory] = (0, import_react6.useState)("series");
  const [activeIcon, setActiveIcon] = (0, import_react6.useState)(true);
  let categories;
...
//# sourceMappingURL=/build/routes/index-DUYG7YGJ.js.map
