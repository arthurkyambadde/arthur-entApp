...
var Thumbnail = (props) => {
  ...
  const [bookmark, setbookmark] = (0, import_react3.useState)(bookmarked);
...
var TrendingMovies = () => {
  const storeData = useMovieDataStore((state) => state.data);
  const data = storeData.filter((item2) => item2.isTrending);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-SWPA3RKW.js.map
