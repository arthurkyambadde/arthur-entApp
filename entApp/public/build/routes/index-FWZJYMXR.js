...
var styles_default6 = "/build/_assets/styles-WROHJBVR.css";
...
var icon_nav_movies_default = "/build/_assets/icon-nav-movies-N7AKFI7F.svg";
...
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var icons = [
  { id: "1", icon: icon_nav_home_default, name: "trending" },
  { id: "2", icon: icon_nav_movies_default, name: "movies" },
  { id: "3", icon: icon_nav_tv_series_default, name: "series" },
  { id: "4", icon: icon_nav_bookmark_default, name: "bookmark" }
];
var trendingMovies = [
  {
    src: small_default,
...
//# sourceMappingURL=/build/routes/index-FWZJYMXR.js.map
