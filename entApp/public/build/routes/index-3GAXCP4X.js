...
var styles_default6 = "/build/_assets/styles-ZZISVQAO.css";
...
var AuthenticatedApplication = () => {
  ...
  const showActiveIcon = (event) => {
    var _a, _b;
    (_a = document.querySelector(".active_icon")) == null ? void 0 : _a.classList.remove("active_icon");
    const iconId = event.currentTarget.id;
    const iconButton = (_b = document.getElementById(iconId)) == null ? void 0 : _b.firstElementChild;
...
//# sourceMappingURL=/build/routes/index-3GAXCP4X.js.map
